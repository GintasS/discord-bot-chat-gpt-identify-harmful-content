...
class BamlAsyncClient:
    ...
    async def ExtractMessageCategoryFromMessage(
        self,
        message: str,
    ...
    async def IdentifyHarmfulDiscordMessage(
        self,
        discord_message: str,
        baml_options: BamlCallOptions = {},
...
class BamlStreamClient:
    ...
    def ExtractMessageCategoryFromMessage(
        ...
        message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[Optional[types.HarmfulMessageCategory], types.HarmfulMessageCategory]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[Optional[types.HarmfulMessageCategory], types.HarmfulMessageCategory](
        raw,
    ...
    def IdentifyHarmfulDiscordMessage(
        ...
        discord_message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.IsHarmfulMessage, types.IsHarmfulMessage]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[partial_types.IsHarmfulMessage, types.IsHarmfulMessage](
        raw,
        lambda x: coerce(partial_mdl, x),
        lambda x: coerce(mdl, x),
        self.__ctx_manager.get(),
